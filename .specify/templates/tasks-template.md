...
**Tests**: Include tests whenever the constitution or feature requires behavioral guarantees.
In this repository, tests for authorization and fallback behavior are REQUIRED when those
flows are impacted.
...
- [ ] T010 [P] Generate/validate typed API client from OpenAPI contract source
- [ ] T011 [P] Implement role extraction and normalization, including wildcard `*` semantics
- [ ] T012 Define route/UI authorization matrix for protected resources
- [ ] T013 Implement unauthorized fallback component with friendly lock indicator
...
- [ ] T012 [P] [US1] Authorization test for allowed/denied role paths
- [ ] T013 [P] [US1] Fallback UI rendering test for unauthorized access
...
- [ ] T022 [P] [US2] Authorization test for protected route/component behavior
...
- [ ] T029 [P] [US3] Unauthorized fallback regression test (no broken screen)
